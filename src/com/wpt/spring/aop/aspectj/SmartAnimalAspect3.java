...
public class SmartAnimalAspect3 {
    ...
    public void f1(JoinPoint joinPoint) {
        ...
        System.out.println("SmartAnimalAspect3切面类方法执行前-日志-方法名  " + signature.getName() + "-参数" +
    ...
    public void f2(JoinPoint joinPoint) {
        Signature signature = joinPoint.getSignature();
        System.out.println("SmartAnimalAspect3切面类方法方法执行正常结束-日志-方法名  " + signature.getName() +
    ...
    public void f3(JoinPoint joinPoint) {
        Signature signature = joinPoint.getSignature();
        System.out.println("SmartAnimalAspect3切面类方法-执行异常-日志-方法名  " + signature.getName());//从AOP看，就是一个横切关注点--返回通知
    }
    ...
    public void f4(JoinPoint joinPoint) {
        Signature signature = joinPoint.getSignature();
        System.out.println("SmartAnimalAspect3切面类方法-最终执行完毕-日志-方法名  " + signature.getName());//从AOP看，就是一个横切关注点--返回通知
    }
    ...
    public void ok(JoinPoint joinPoint){
        Signature signature = joinPoint.getSignature();
        System.out.println("SmartAnimalAspect3切面类的ok方法--执行的目标方法---" + signature.getName());
    }
